...
class SVMstrategies:
    def __init__(self, btc_price_df, cache_prefix, features):
        ...
        self.scaler_path = cache_prefix + 'svm_scaler.joblib'
        self.imputer_path = cache_prefix + 'svm_imputer.joblib'
        self.test_accuracy_path = cache_prefix + 'svm_test_accuracy.joblib'
    ...
    def preprocess_and_train(self):
        ...
        self.svm_model = self.optimize_hyperparameters(X_train, y_train, search_type='random')
